...
export default function Editor() {
    ...
    async function upload(file?: File) { if (!file)
        ...
        setMessage('The attachment limit is 20 MB. Link to larger files instead.');
        return;
